...
class PlanRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/v1/aps/plan
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new PlanRequestBuilder and sets the default values.
    ...
    def with_url(self,raw_url: str) -> PlanRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: PlanRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return PlanRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class PlanRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
