...
if TYPE_CHECKING:
    from .analytical_patterns.analytical_patterns_request_builder import AnalyticalPatternsRequestBuilder
...
class ApManagementClient(BaseRequestBuilder):
    ...
    @property
    def analytical_patterns(self) -> AnalyticalPatternsRequestBuilder:
        """
        The analyticalPatterns property
        """
        from .analytical_patterns.analytical_patterns_request_builder import AnalyticalPatternsRequestBuilder

        return AnalyticalPatternsRequestBuilder(self.request_adapter, self.path_parameters)
